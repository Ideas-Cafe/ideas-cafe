...
const Button = ({ value = "", func = () => {}, icon = "", className = "" }) => {
  const buttonClick = () => {
    func();
  };
  const defualtstyling =
    "px-7 h-8.5 text-center text-black rounded-4xl bg-amber-100 transition-all duration-300 hover:h-9 hover:scale-x-105";
