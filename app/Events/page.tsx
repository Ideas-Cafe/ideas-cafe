    ...
    <>
      <div className="w-full bg-amber-50" id="Event">
        ...
        <div className="py-13 flex-1 justify-center items-center">
          <p className="text-center text-3xl font-semibold">Mentor Moments</p>
          <p className="text-amber-800 font-medium text-center mx-10 my-4">
        ...
        <div className="py-13 flex-1 justify-center items-center">
          ...
          <p className="text-amber-800 font-medium text-center mx-30 my-4">
