    ...
    <>
      ...
      >
        <div className="text-center space-y-2 text-black ">
          ...
          <p className="text-md max-sm:mx-1.5 max-sm:text-xs font-normal mb-8 max-sm:mb-7 animate-[slide-pop_2s_ease-in-out_1_alternate_forwards]">
          ...
          <Button
            ...
            icon={Right_Arrow}
            func={TestFunction}
            className="text-white bg-black max-sm:w-40 max-sm:h-15 max-sm:-mt-1"
          />
        </div>
      </div>
    </>
